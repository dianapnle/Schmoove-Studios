...
export const thunkUpdateInstructor =
  (payload, profilePic, instructorId) => async (dispatch) => {
...
export const thunkCreateInstructor =
  (payload, profilePic, studioId) => async (dispatch) => {
    const pic_b64data = profilePic ? await toBase64(profilePic) : undefined
