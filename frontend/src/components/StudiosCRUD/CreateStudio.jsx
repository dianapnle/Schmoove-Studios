      ...
      <div className='modal-login'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='area'>
            ...
            {hasSubmitted === true && errors.logo && (
              <div className={`errors`}>{errors.logo}</div>
            )}
          </div>
          <div className='area'>
            <label>
            ...
            {hasSubmitted === true && errors.pic && (
              <div className={`errors`}>{errors.pic}</div>
            )}
          </div>
          <div className='area'>
            <label>
          ...
          <div className='buttons-container'>
            <button type='submit' className='submit-btn' disabled={toggle()}>
              Create Studio
            </button>
          </div>
        </form>
